...
export const customResponses: Record<string, string> = {
	...
	Chatgpt: "As an AI language model, I can't generate content that promotes or encourages violence, harm, or illegal activities. My purpose is to assist and provide information in a safe and ethical manner.",
...
][] = [[["🇸", "🇭", "🇺", "🇹", "😠"], [`<@${client.user.id}>`, "partial"]],["🍪","cookie"],["<:haha:1237847801073897583>","@everyone"]];
